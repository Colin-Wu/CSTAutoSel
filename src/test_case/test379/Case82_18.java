...
public class Case82_18 {
	...
	public static String run (WebDriver webdriver) throws Exception {
		...
		String vOrdAttr = TestSetting.OrdAttr_IntRepair;
		...
		if (retArr.size() > 0) {
			...
			if (retObj != null) {
				...
				if (TotalOrderCnt.equals("2")) {
					...
					CommUtil.logger.info(" > parent order cancel button invisible, child1 invisible.");					
