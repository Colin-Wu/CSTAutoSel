...
/*        	while (!TestSetting.reslist.addSN("82_10",inExpectedSendoutSN)) {
        		boxidx++;
			...
			if (retObj != null) {
				...
				if (TotalOrderCnt.equals("3")) {
					...
					CommUtil.logger.info(" > parent order cancel button invisible, 2 child visible.");					
