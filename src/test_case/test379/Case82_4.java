...
public class Case82_4 {
	...
	public static String run (WebDriver webdriver) throws Exception {
		...
		String BoxCnt = "1";
		String PalletCnt = "1";
		String StockGroup = TestSetting.StockGroup;
		...
		InputObj.put("OrdNum", "");		
		InputObj.put("StockGroup", StockGroup);		
		...
		if (!retVal.equals("0")) {
			retVal = "-1";
			CommUtil.logger.info("CreateStdPO_CA - Failure. Code:"+retVal);
			return retVal;
		}			
		...
		if (isFound.equals("1")) {
			...
			if (!retVal.equals("0")) {
				retVal = "-1";
				CommUtil.logger.info("DeletePO - Failure. Code:"+retVal);
				return retVal;
			}	
		} else {
			retVal = "-1";
			CommUtil.logger.info("SearchPO_CA - Failure. Code:"+retVal);
			return retVal;			
		}		
