...
public class Case92_2 {
	public static String run (WebDriver webdriver) throws Exception {
		...
		String vOrdAttr = TestSetting.OrdAttr_ExtRepair;
...
/*			HashMap<String, String> Retobj = retArr.get(0);
			...
			String inExpectedSendoutSN = Retobj.get("SN");
/*        	while (!TestSetting.reslist.addSN("92_2",inExpectedSendoutSN)) {
        		boxidx++;
			...
			PartAddMap.put("ExpectedSN", inExpectedSendoutSN);
			...
			if (retObj != null) {
				...
				if (TotalOrderCnt.equals("2")) {
					...
					if(retstr.equals("0")) {
						...
						if (OrdStatus.equals("Cancel")) {
							retVal = "0";
							CommUtil.logger.info("Child Order cancel successfully.");
						} else {
