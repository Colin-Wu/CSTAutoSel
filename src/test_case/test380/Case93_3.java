			...
			if (TotalOrderCnt.equals("1")) {
				...
				if (outIsFound.equals("1")) {
					...
					if (CommUtil.isMatchByReg(Location.toUpperCase(), vRepairLocation.toUpperCase())) {
						retVal = "0";
						CommUtil.logger.info("> HP part(Non-Warranty) successfully putaway to repair location.");
					} else {
						CommUtil.logger.info("> HP part(Non-Warranty) failed to putaway to repair location.");
					}
