...
public class ShippingListObj {
	...
	By TblSearchResultLocator = By.xpath(".//div[@id='ContentPlaceHolder1_UpdatePanel1']/table/tbody");	
	...
	public ShippingListObj(WebDriver driver) {
		super();
	...
	public WebElement getLinkShipping(int idx) throws NoSuchElementException  {
		WebElement retEle = null;
